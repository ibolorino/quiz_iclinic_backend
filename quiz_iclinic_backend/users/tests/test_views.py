...
from quiz_iclinic_backend.users.models import User
from quiz_iclinic_backend.users.tests.factories import UserFactory
from quiz_iclinic_backend.users.views import (
    UserRedirectView,
    UserUpdateView,
    user_detail_view,
)
